...
dci\_gather\_logs                  | true                                                 | Collect OCP logs
...
| certsuite_config.yml                           | Files   | The config file passed to certsuite (if enabled)                                          |
| certsuite-stdout.log and certsuite.log         | Files   | The output of certsuite execution, for troubleshooting purposes (if enabled)              |
| certsuite-tests_junit.xml                      | Files   | JUnit file gathering certsuite results (if enabled)                                       |
